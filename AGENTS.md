...
- 当在处理添加新组件、引用新语言等情况时，使用context7学习最佳语言实践

- 使用consequential thinking提升认知深度以及决策复杂度，保证开发的一致性和连续性
- 使用deepwiki学习github上面比较好的项目经验
- 使用dart mcp来处理所有开发flutter时存在的问题
- 使用chrome devtools优先调试UI/UX、交互性、美观、渲染效率等问题
- **必须使用ace-tools进行项目分析**