...
- scanned UI files: 218
- scanned src files (excluding src/actions): 316
...
- `createEvent`（UI: 4，例：`src/components/calendar/CanvasCalendar.tsx`, `src/components/cases/CaseDetailTabsPanel.tsx`, `src/components/tasks/TaskDetailDialog.tsx` +1）
