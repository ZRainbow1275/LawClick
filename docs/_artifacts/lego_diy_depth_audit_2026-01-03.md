...
| LegoDeck | - | `documents_list_grid_cards` | `lawclick-next/src/components/documents/DocumentListClient.tsx:495` |
...
| SectionWorkspace | - | `case_sidebar` | `lawclick-next/src/components/cases/CaseDetailClient.tsx:439` |
