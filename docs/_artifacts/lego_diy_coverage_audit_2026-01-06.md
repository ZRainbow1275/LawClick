# 全站乐高化 DIY 覆盖审计（Dashboard）（2026-01-06）
...
- ✅ `lawclick-next/src/app/(dashboard)/layout.tsx:80` uses `<PageWorkspace>`
...
| `/documents/:id/review` | `lawclick-next/src/app/(dashboard)/documents/[id]/review/page.tsx` | `lawclick-next/src/components/documents/DocumentReviewClient.tsx` | via-component |
| `/documents/:id/workbench` | `lawclick-next/src/app/(dashboard)/documents/[id]/workbench/page.tsx` | `lawclick-next/src/components/documents/DocumentWorkbenchWorkspaceClient.tsx` | via-component |
...
| `/team/:id/card` | `lawclick-next/src/app/(dashboard)/team/[id]/card/page.tsx` | `lawclick-next/src/app/(dashboard)/team/[id]/card/page.tsx` | direct |
...
| `/tools` | `lawclick-next/src/app/(dashboard)/tools/page.tsx` | `lawclick-next/src/components/tools/ToolsPageClient.tsx` | via-component |
